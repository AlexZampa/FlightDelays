...
public class ExtFlightDelaysDAO {
	...
	public int getAirlinesNumber(Airport airport) {
	...
	public List<Rotta> getRotte(Map<Integer, Airport> idMap) {
		...
		try {
			...
			while(res.next()) {
				Airport sorgente = idMap.get(res.getInt("origin_airport_id"));
				Airport destinazione = idMap.get(res.getInt("destination_airport_id"));
				
				if(sorgente != null && destinazione != null) {
					result.add(new Rotta(sorgente, destinazione, res.getInt("tot")));
				}
				else {
